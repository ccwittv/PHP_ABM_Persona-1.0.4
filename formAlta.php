...
<?php     
	...
	{
		$unaPersona = Persona::TraerUnaPersona($_POST['legajoParaModificar']);
		$titulo = "MODIFICACIÓN";
	} 
?>
	<div class="container">
		...
		<div class="CajaInicio animated bounceInRight">
			...
			<form id="FormIngreso" method="post" action="formAlta.php" enctype="multipart/form-data" >
			  <div class="form-group">	
				<input class="form-control" type="text" name="apellido" id="apellido" placeholder="ingrese apellido" value="<?php echo isset($unaPersona) ?  $unaPersona->GetApellido() : "" ; ?>" /><span id="lblApellido" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
				<input class="form-control" type="text" name="nombre" id="nombre" placeholder="ingrese nombre" value="<?php echo isset($unaPersona) ?  $unaPersona->GetNombre() : "" ; ?>" /> <span id="lblNombre" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
				<input class="form-control" type="text" name="legajo" id="legajo" placeholder="ingrese legajo" value="<?php echo isset($unaPersona) ?  $unaPersona->GetLegajo() : "" ; ?>" <?php echo isset($unaPersona) ?  "disabled": "" ; ?>        /> <span id="lblLegajo" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
